...
/**
https://liuns.com/ 的飞机场每日签到，多账户版，多余的账户，请于List中删除
邀请链接https://liuns.com/auth/register?code=SNoq
*/
// Liuns 类
type Liuns struct {
...
// MsgPush 消息推送处理接口
func (v *Liuns) MsgPush(msg string) {
	// 优先推送 独立配置
